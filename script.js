...
const maxSpins = 3; // Set maximum spins
...
spinBtn.addEventListener("click", () => {
      ...
      if (spinCount >= maxSpins) {
        finalValue.innerHTML = `<p style="color: #ffff; font-size: 12px;">Free spins are over.  Buy more spins following the instruction.</p>
